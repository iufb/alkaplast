...
const Form = () => {
    ...
    const { mutate, isLoading, isError } = useMutation({ mutationKey: ['CreateWorker'], mutationFn: rCreateWorker })
    ...
    return <form onSubmit={submit}>
        <Stack>
            ...
            <Button type="submit" loading={isLoading} disabled={isLoading}>Создать</Button>
        </Stack>
    </form>
}
